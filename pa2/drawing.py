...
# pylint: disable-msg= too-many-locals, unused-argument, bare-except
# pylint: disable-msg= assignment-from-none, no-self-use, protected-access
...
class ChiCanvas:
    ...
    def draw_text_vertical(self, x0, y0, h, txt, fg="black", debug=False):
        ...
        '''
        self._draw_text_with_rotation(
            x0, y0, 0.03, h, txt,
            offset_y=h/2.0-0.02, fg=fg, rotation=90, debug=debug)
    ...
    def _draw_text_with_rotation(self, x0, y0, w, h, txt, offset_x=0,
        ...
        # when clipping text
        textobj._clip = TransformedBbox(
            bbox=Bbox(((x0-w/2.0, y0-h/2.0), (x0+w/2, y0+h/2.0))),
